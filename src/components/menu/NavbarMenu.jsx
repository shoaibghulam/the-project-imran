...
export function NavbarMenu() {
    const theme={
        "root": {
          "base": "text-primary px-2 py-2.5 sm:px-4",
          "rounded": {
            "on": "rounded",
            "off": ""
          },
        ...
        "collapse": {
          ...
          "list": "text-center mt-4 flex flex-col md:mt-0 md:flex-row md:space-x-8 md:text-sm md:font-medium",
          "hidden": {
            "on": "hidden",
            "off": ""
          }
  ...
  return (
    <Navbar fluid rounded theme={theme}>
      <Navbar.Brand>
      <img src={logoimg}/>
      </Navbar.Brand>
